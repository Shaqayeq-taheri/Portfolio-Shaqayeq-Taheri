...
<button  className="text-xl mx-auto md:mx-0  w-48 bg-rose-100 hover:bg-rose-200 transition delay-100 p-4 ">My CV</button>
      
      </div>         
    <img src="src/assets/images/myImage.jpg" alt="" className="  rounded-full order-first md:order-last mb-2 mt-10 md:mt-0 md:mb-20" style={{width:'200px', height:'210px' }} />
